...
public class ConsultationController {
    ...
    public String deleteConsultation(@PathVariable("id") int id, HttpSession session, RedirectAttributes redirAttr) {
    ...
    public String createConsultation(@ModelAttribute Consultation consultation, HttpSession session, RedirectAttributes redirAttr) {
        redirAttr.addFlashAttribute("error", service.createConsultation(consultation));
        return "redirect:/findPatient/" + session.getAttribute("patient_id");
    }

    @GetMapping("/watchConsultation/{id}")
    public String watchConsultation(@PathVariable("id") int id, Model model) {
    ...
    public String GetEditConsultation(@PathVariable("id") int id, Model model) {
        model.addAttribute("consultation", service.findConsultationById(id));
    ...
    public String editConsultation(@ModelAttribute Consultation consultation, HttpSession session, RedirectAttributes redirAttr) {
